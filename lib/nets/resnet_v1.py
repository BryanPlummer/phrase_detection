...
class resnetv1(Network):
  def __init__(self, output_dir = None, num_layers=50, vecs = None, max_tokens = None):
    Network.__init__(self, output_dir, vecs, max_tokens)
  ...
  def _head_to_tail(self, pool5, is_training, reuse=None):
    with slim.arg_scope(resnet_arg_scope(is_training=is_training, reuse=reuse)):
