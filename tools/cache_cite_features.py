...
if __name__ == '__main__':
  ...
  # load network
  if args.net == 'vgg16':
    net = vgg16(vecs=vocab['vecs'], max_tokens=vocab['max_tokens'])
  elif args.net == 'res50':
    net = resnetv1(num_layers=50, vecs=vocab['vecs'], max_tokens=vocab['max_tokens'])
  elif args.net == 'res101':
    net = resnetv1(num_layers=101, vecs=vocab['vecs'], max_tokens=vocab['max_tokens'])
  elif args.net == 'res152':
    net = resnetv1(num_layers=152, vecs=vocab['vecs'], max_tokens=vocab['max_tokens'])
  else:
  ...
  cache_gt_features(sess, net, imdb, filename, max_per_image=args.max_per_image)
